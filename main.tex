...
% Aliases
\input{aliases.tex}
\input{bandstructure_SCF_data.tex}
\input{bandstructure_G0W0_data.tex}
...
\caption{Electronic band structure from the self-consistent field (SCF) electronic structure method. The energy of the bands is given relative to the valence band maximum (VBM).}
    \label{fig:Efield}
\end{figure}
